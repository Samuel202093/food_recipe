...
<div className='flex justify-end gap-4 border-2y border-[yellow]y cursor-pointer md:mr-2 lg:mr-[6.3rem]'>
  <span onClick={prePage} className='border-[1px] border-slate-600 px-2 py-1 text-sm'>Prev</span> 
  {
      numbers.map((n, i)=>{
    ...
    <span onClick={nextPage} className='border-[1px] border-slate-600 px-2 py-1 text-sm'>Next</span>
</div>
</div>
  )
}
