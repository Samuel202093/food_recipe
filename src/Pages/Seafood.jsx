...
const Seafood = () => {
    let { data, error, isLoading } = useSWR("https://www.themealdb.com/api/json/v1/1/filter.php?c=Seafood", fetcher)
...
if (error) {
  ...
  return (
    <div className='min-h-[70vh] mt-5'>
      <h2 className='heading-explore text-2xl font-semibold text-center text-slate-600 mb-7'>Different Seafood Dishes</h2>
