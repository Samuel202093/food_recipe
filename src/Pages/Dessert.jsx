...
const Dessert = () => {
    let { data, error, isLoading } = useSWR("https://www.themealdb.com/api/json/v1/1/filter.php?c=Dessert", fetcher)
...
if (isLoading) {
  return (
    <div className='absolute top-[35%] md:top-[40%] left-[35%] md:left-[50%] flex justify-center items-center'>
...
if (error) {
  ...
  return (
    ...
    <h2 className='heading-explore text-2xl font-semibold text-center text-slate-600 mb-7'>Different Dessert Dishes</h2>
